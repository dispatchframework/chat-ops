...
def handle(ctx, payload):
    ...
    host = payload.get("host", secrets.get("host"))
    port = payload.get("port", secrets.get("port", 443))
    if host is None:
    ...
    dc_name = payload.get("datacenter", secrets.get("datacenter"))
    host_name = payload.get("hostName")
    vm_folder = payload.get("vmFolder", secrets.get("vmFolder"))
    resource_pool = payload.get("resourcePool", secrets.get("resourcePool"))
